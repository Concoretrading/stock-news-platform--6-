...
export function StockCard({ ticker, name, onClick }: StockCardProps) {
  return (
    <Card 
      className="hover:shadow-xl transition-all duration-300 cursor-pointer group border-2 hover:border-blue-300 bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 h-24 sm:h-32 md:h-40 relative"
      onClick={onClick}
    >
      <CardContent className="p-2 sm:p-4 md:p-6 h-full flex flex-col justify-center">
        {/* Header Section - Now centered and taking full space */}
        <div className="flex-1 flex flex-col justify-center text-center">
          <h3 className="font-bold text-lg sm:text-2xl md:text-3xl lg:text-4xl text-gray-900 dark:text-white group-hover:text-blue-600 transition-colors mb-1 sm:mb-2 md:mb-3">
            {ticker}
          </h3>
