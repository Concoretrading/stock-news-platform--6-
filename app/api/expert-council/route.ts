    ...
    if (action === 'train') {
      ...
      return NextResponse.json({
        ...
        market_context: {
          ...
          price_change_24h: calculatePriceChange(recentData),
          volume_trend: calculateVolumeTrend(recentData)
        },
        execution_guidance: {
          ...
          position_size_suggestion: calculatePositionSize(decision),
          stop_loss_suggestion: calculateStopLoss(recentData, decision)
        }
      });
